...
public class SnakesLaddersBoard {
    ...
    private void modifyBoard() {
         ...
         * //This could be a setting in the game using Enums later I just add it for
         * demonstration
         * int difficulty = 20;
        ...
        // Note that I don't really understand expansion, like if the space you land on
        // has
    ...
    private void changeSpacesToLadders(int howMany) {
        ...
        for (int i = 0; i < howMany; i++) {
            ...
            while (from < start || to > end) {
                // since I first made snakes I just need to check I don't override a snake to
                // ladder
